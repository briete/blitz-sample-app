...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/aws-saas-boost-deploy-sample
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/aws-saas-boost-deploy-sample_test
```
